...
const Booking = () => {
    ...
    useEffect(() => {
        fetch(`https://haunted-scarecrow-80028.herokuapp.com/Services/${serviceId}`)
            .then(res => res.json())
    ...
    const onSubmit = data => {
        ...
        axios.post('https://haunted-scarecrow-80028.herokuapp.com/order',data)
        .then(res=>{
            console.log(res); 
    ...
    return (
        <div className='bookResponsive row'>
            <h2 className='text-primary'><u> Details </u></h2>
